...
def populate(): 
    ...
    recipes = {
        ...
        {'comments':'lemon_baked_cheesecake',
        'category':'Dessert',
        ...
        {'comments':'Cod_with_butter_bean_colcannon',
        'category':'Seafood',
        ...
        {'comments':'Tomato_penne_with_avocado',
        'category':'Vegetarian',
    ...
    Cod_with_butter_bean_colcannon = [
